...
export default function Branding() {
  return (
    <div className={`${style.section}`}>
      <div className="my-12 flex justify-between w-full">
        <div className="flex items-center bg-white rounded-md shadow py-5 px-8 gap-4">
        ...
        <div className="flex items-center bg-white -md shadow  py-5 px-8 gap-4">
